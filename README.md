...
- LiveShell X は未対応です
- 本ツール公開にあたっては、YouTube API の利用規約・ブランドガイドラインの遵守が必要です
- 本ツールは非公式であり、Cerevo/YouTube とは無関係です（ロゴや商標の無断使用は避けてください）
- デバイスの利用規約/EULAに「リバースエンジニアリング禁止」等がある場合、公開範囲に影響する可能性があります
- 本READMEの内容は法的助言ではありません
